...
class BST(BinaryTree):
    ...
    def __repr__(self):
        ...
        can be used to recreate a valueid instance of the class.
    ...
    def _insert(root, value):
        if not root:
            ...
            if root.value == value:
                ...
                root.right = BST._insert(root.right, value)
            else:
                root.left = BST._insert(root.left, value)
        return root
    ...
    def __contains__(self, value):
        '''
        Recall that `x in tree` desugars to
        `tree.__contains__(x)`.
        '''
    ...
    def find(self, value):
        '''
        Returns whether value is contained
        in the BST.
    ...
    def _find(value, root):
        ...
        if not root:
            ...
            return BST._find(value, root.right)
        else:
            return BST._find(value, root.left)
    ...
    def _remove(root, value):
        if root.value > value:
            ...
            if not root.right:
                ...
                temp = root.right
                # tree_minimum = temp.value
                while temp.left:
                    temp = temp.left
                    # tree_minimum = temp.value
                root.right = BST._remove(root.right, root.value)
        return root
